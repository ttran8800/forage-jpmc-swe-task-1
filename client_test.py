...
class ClientTest(unittest.TestCase):
  ...
  def test_getRatio_priceBisZero(self):
    quote = {'top_ask': {'price': 119.2, 'size': 36}, 'timestamp': '2019-02-11 22:06:30.572453', 'top_bid': {'price': 0, 'size': 109}, 'id': '0.109974697771', 'stock': 'ABC'}
    """ ------------ Add the assertion below ------------ """
    self.assertIsNot(getRatio(quote['top_ask']['price'], quote['top_bid']['price']), ())
